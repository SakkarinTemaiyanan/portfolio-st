  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/profile.php?id=100006496718480"
            ...
            <li>
              <a
                href="https://www.instagram.com/nnight_te/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://github.com/SakkarinTemaiyanan/"
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with by Sakkarin Temiyanan</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
